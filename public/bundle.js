...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Saved = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Query = __webpack_require__(162);
	...
	var Search = function (_React$Component) {
	  ...
	  _createClass(Search, [{
	    ...
	    value: function updateDataBase(saveId) {
	      ...
	      _Helpers2.default.postSaved(topic, url, pub_date).then(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
	  ...
	  postSaved: function postSaved(title, url, pub_date) {
	    return _axios2.default.post("/api/saved", { title: title, url: url, pub_date: pub_date });
	  },
